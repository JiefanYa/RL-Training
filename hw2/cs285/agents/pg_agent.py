...
class PGAgent(BaseAgent):
    ...
    def train(self, obs, acs, rews_list, next_obs, terminals):
        ...
        # step 3:
        # TODO: pass the calculated values above into the actor/policy's update: Done
    ...
    def calculate_q_vals(self, rews_list):
        ...
        if not self.reward_to_go:
            ...
            # TODO: Estimate the Q value Q^{pi}(s_t, a_t) using rewards from that entire trajectory: Done
        ...
        # Case 2: reward-to-go PG 
            ...
            # TODO: Estimate the Q value Q^{pi}(s_t, a_t) as the reward-to-go: Done
    ...
    def estimate_advantage(self, obs, q_values):
        ...
        # TODO: Estimate the advantage when nn_baseline is True: Done
